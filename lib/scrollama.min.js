!function (e, t) {
    ...
    function S({id: e, step: t, marginTop: n}) {
        var {index: o, height: t} = t, o = `scrollama__debug-step--${e}-${o}`;
    ...
    return function () {
        let r = {}, s = function () {
            var t = "abcdefghijklmnopqrstuvwxyz", e = Date.now();
            const n = [];
            for (let e = 0; e < 6; e += 1) {
        ...
        function i(e, t) {
            ...
            t = {element: e, index: n, progress: t, direction: N};
        ...
        function a([e]) {
            ...
            (t ? function (e) {
                ...
                e = {
                    ...
                    index: t,
                    direction: N
                }, n.direction = N, n.state = "enter", o[t] || r.stepEnter(e), g && (o[t] = !0)
            } : function (e) {
                var t = M(e);
                const n = f[t];
                n.state && (t = {
        ...
        function c([e]) {
            var t = M(e.target), n = f[t], {isIntersecting: o, intersectionRatio: t, target: e} = e;
        ...
        function E(e) {
            var t = window.innerHeight, n = e.offset || l, o = "pixels" === n.format ? 1 : t, n = n.value * o,
                o = e.height / 2 - n, n = e.height / 2 - (t - n);
            const r = new IntersectionObserver(a, {rootMargin: `${o}px 0px ${n}px 0px`, threshold: .5});
            r.observe(e.node), e.observers.step = r, h && S({id: s, step: e, marginTop: o, marginBottom: n})
        }

        function e(e) {
            var t = window.innerHeight, n = e.offset || l, o = "pixels" === n.format ? 1 : t, o = n.value * o,
                o = `${-o + e.height}px 0px ${o - t}px 0px`, t = function (e, t) {
                    var n = Math.ceil(e / t);
                    const o = [];
                    var r = 1 / n;
            ...
            const r = new IntersectionObserver(c, {rootMargin: o, threshold: t});
            r.observe(e.node), e.observers.progress = r
        }

        function w() {
            b(), f.forEach(y), f.forEach(E), d && f.forEach(e)
        }
